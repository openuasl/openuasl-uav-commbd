#ifndef _OPENUASL_COMMBD_MULTIWII_SERIAL_CONNECTION_H_
#define _OPENUASL_COMMBD_MULTIWII_SERIAL_CONNECTION_H_
...
#endif /* _OPENUASL_COMMBD_MULTIWII_SERIAL_CONNECTION_H_ */
